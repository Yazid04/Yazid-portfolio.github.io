...
const Footer = () => {
  ...
  return (
    <section
      className={`w-full h-min font-sourceSansPro py-5 text-dark bg-light mx-auto mt-10 grid place-content-center`}
    >
        ...
        <div className="md:flex md:flex-col">
          <div className="min-w-[18rem] h-20 grid grid-cols-2 grid-rows-2 text-center gap-5 my-4 md:my-0">
            <li className="list-none">
              <button className="overflow-hidden">Privacy & Terms</button>
            </li>
            <li className="list-none">
          ...
          <div
            className={`h-10 mb-4 md:w-full md:h-20 grid place-content-center`}
          >
